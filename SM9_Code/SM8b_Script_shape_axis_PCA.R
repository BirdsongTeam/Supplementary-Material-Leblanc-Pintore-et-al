...
open3d()##### open a new rgl windows if you want to plot separately shape deformation use this function before plot the next plot, if you do you can turn off the opacity by setting alpha=1
############Minimum
