...
classification <- read_delim("C:/Users/ReeLz/OneDrive/Bureau/Killian_landmarkage_symmetrized/classification.csv", 
...
cbind(classification_D2D3$ID,row.names(GPA_D2D3$PCscores))####Double check
...
PCA_D1D1 <- {plot(GPA_D1P1$PCscores[,1],GPA_D1P1$PCscores[,2])
text(GPA_D1D1$PCscores[,1],GPA_D1D1$PCscores[,2],labels=classification$sp2)}

PCA_D1D2 <- {plot(GPA_D1P2$PCscores[,1],GPA_D1P2$PCscores[,2])
  text(GPA_D1D2$PCscores[,1],GPA_D1D2$PCscores[,2],labels=classification$sp2)}

PCA_D2D1 <- {plot(GPA_D2P1$PCscores[,1],GPA_D2P1$PCscores[,2])
  text(GPA_D2D1$PCscores[,1],GPA_D2D1$PCscores[,2],labels=classification$sp2)}

PCA_D2D2 <- {plot(GPA_D2P2$PCscores[,1],GPA_D2P2$PCscores[,2])
  text(GPA_D2D2$PCscores[,1],GPA_D2D2$PCscores[,2],labels=Classification_inter_terminal$sp2)}

PCA_D2D3 <- {plot(GPA_D2p3$PCscores[,1],GPA_D2P3$PCscores[,2])
  text(GPA_D2D3$PCscores[,1],GPA_D2D3$PCscores[,2],labels=classification_D2P3$sp2)}

PCA_D3D1 <- {plot(GPA_D3p1$PCscores[,1],GPA_D3P1$PCscores[,2])
  text(GPA_D3D1$PCscores[,1],GPA_D3D1$PCscores[,2],labels=classification$sp2)}

PCA_D3D2 <- {plot(GPA_D3P2$PCscores[,1],GPA_D3P2$PCscores[,2])
  text(GPA_D3D2$PCscores[,1],GPA_D3D2$PCscores[,2],labels=Classification_inter_terminal$sp2)}

PCA_D3D3 <- {plot(GPA_D3P3$PCscores[,1],GPA_D3P3$PCscores[,2])
  text(GPA_D3D3$PCscores[,1],GPA_D3D3$PCscores[,2],labels=classification_D3P3_D4P4$sp2)}

PCA_D3D4 <- {plot(GPA_D3P4$PCscores[,1],GPA_D3P4$PCscores[,2])
  text(GPA_D3D4$PCscores[,1],GPA_D3D4$PCscores[,2],labels=classification_D3D4$sp2)}

PCA_D4D1 <- {plot(GPA_D4P1$PCscores[,1],GPA_D4P1$PCscores[,2])
  text(GPA_D4D1$PCscores[,1],GPA_D4D1$PCscores[,2],labels=classification$sp2)}

PCA_D4D2 <- {plot(GPA_D4P2$PCscores[,1],GPA_D4P2$PCscores[,2])
  text(GPA_D4D2$PCscores[,1],GPA_D4D2$PCscores[,2],labels=Classification_inter_terminal$sp2)}

PCA_D4D3 <- {plot(GPA_D4P3$PCscores[,1],GPA_D4P3$PCscores[,2])
  text(GPA_D4D3$PCscores[,1],GPA_D4D3$PCscores[,2],labels=Classification_inter_terminal$sp2)}

PCA_D4D4 <- {plot(GPA_D4P4$PCscores[,1],GPA_D4P4$PCscores[,2])
  text(GPA_D4D4$PCscores[,1],GPA_D4D4$PCscores[,2],labels=classification_D3P3_D4P4)}

PCA_D4D5 <- {plot(GPA_D4P5$PCscores[,1],GPA_D4P5$PCscores[,2])
  text(GPA_D4D5$PCscores[,1],GPA_D4D5$PCscores[,2],labels=Classification_inter_terminal$sp2)}


PCA_tmt <- {plot(GPA_tmt$PCscores[,1],GPA_tmt$PCscores[,2])
  text(GPA_tmt$PCscores[,1],GPA_tmt$PCscores[,2],labels=ptslist)}
...
plot_d3p3 <- ggplot(dat_d3p3 , aes(dat_d3p3[,1], dat_d3p3[,2],color=classification_D3P3_D4P4$`Perching performance` ,label = classification_D3P3_D4P4$sp2,shape=classification_D3P3_D4P4$Locomotion)) +
  geom_point(size=7) + geom_text_repel(color="black") + labs(title = "") + geom_encircle(aes(group=classification_D3P3_D4P4$`Perching performance`,fill=classification_D3P3_D4P4$`Perching performance`),colour="darkred", s_shape = 1, expand = 0,
                                                                                         alpha = 0.20, show.legend = FALSE)+xlab("PC1")+ylab("PC2")+scale_shape_manual(values=c(8, 19,17))+scale_color_manual(values=c("#193EE2", "#009E73", "#F0E442"))+scale_fill_manual(values=c("#56B4E9", "#009E73", "#F0E442"))+ theme_classic()+ geom_hline(yintercept=0, linetype="dashed",color = "black", size=0.8,alpha=0.1) +geom_vline(xintercept = 0, linetype="dashed",color = "black", size=0.8,alpha=0.1)
plot_d3p4 <- ggplot(dat_d3p4 , aes(dat_d3p4[,1], dat_d3p4[,2],color=classification_D3P4$`Perching performance` ,label = classification$sp2,shape=classification$Locomotion)) +
  geom_point(size=7) + geom_text_repel(color="black") + labs(title = "") + geom_encircle(aes(group=classification$`Perching performance`,fill=classification$`Perching performance`),colour="darkred", s_shape = 1, expand = 0,
                                                                                         alpha = 0.20, show.legend = FALSE)+xlab("PC1")+ylab("PC2")+scale_shape_manual(values=c(8, 19,17))+scale_color_manual(values=c("#193EE2", "#009E73", "#F0E442"))+scale_fill_manual(values=c("#56B4E9", "#009E73", "#F0E442"))+ theme_classic()+ geom_hline(yintercept=0, linetype="dashed",color = "black", size=0.8,alpha=0.1) +geom_vline(xintercept = 0, linetype="dashed",color = "black", size=0.8,alpha=0.1)
...
plot_d4p1 <- ggplot(dat_d4p1 , aes(dat_d4p1[,1], dat_d4p1[,2],color=classification$`Perching performance` ,label = classification$sp2,shape=classification$Locomotion)) +
  geom_point(size=7) + geom_text_repel(color="black") + labs(title = "") + geom_encircle(aes(group=classification$`Perching performance`,fill=classification$`Perching performance`),colour="darkred", s_shape = 1, expand = 0,
                                                                                         alpha = 0.20, show.legend = FALSE)+xlab("PC1")+ylab("PC2")+scale_shape_manual(values=c(8, 19,17))+scale_color_manual(values=c("#193EE2", "#009E73", "#F0E442"))+scale_fill_manual(values=c("#56B4E9", "#009E73", "#F0E442"))+ theme_classic()+ geom_hline(yintercept=0, linetype="dashed",color = "black", size=0.8,alpha=0.1) +geom_vline(xintercept = 0, linetype="dashed",color = "black", size=0.8,alpha=0.1)
plot_d4p2 <- ggplot(dat_d4p2 , aes(dat_d4p2[,1], dat_d4p2[,2],color=classification$`Perching performance` ,label = classification$sp2,shape=classification$Locomotion)) +
  geom_point(size=7) + geom_text_repel(color="black") + labs(title = "") + geom_encircle(aes(group=classification$`Perching performance`,fill=classification$`Perching performance`),colour="darkred", s_shape = 1, expand = 0,
                                                                                         alpha = 0.20, show.legend = FALSE)+xlab("PC1")+ylab("PC2")+scale_shape_manual(values=c(8, 19,17))+scale_color_manual(values=c("#193EE2", "#009E73", "#F0E442"))+scale_fill_manual(values=c("#56B4E9", "#009E73", "#F0E442"))+ theme_classic()+ geom_hline(yintercept=0, linetype="dashed",color = "black", size=0.8,alpha=0.1) +geom_vline(xintercept = 0, linetype="dashed",color = "black", size=0.8,alpha=0.1)

plot_d4p3 <- ggplot(dat_d4p3 , aes(dat_d4p3[,1], dat_d4p3[,2],color=classification_D4D3$`Perching performance` ,label = classification_D4D3$sp2,shape=classification_D4D3$Locomotion)) +
  geom_point(size=7) + geom_text_repel(color="black") + labs(title = "") + geom_encircle(aes(group=classification_D4D3$`Perching performance`,fill=classification_D4D3$`Perching performance`),colour="darkred", s_shape = 1, expand = 0,
                                                                                         alpha = 0.20, show.legend = FALSE)+xlab("PC1")+ylab("PC2")+scale_shape_manual(values=c(8, 19,17))+scale_color_manual(values=c("#193EE2", "#009E73", "#F0E442"))+scale_fill_manual(values=c("#56B4E9", "#009E73", "#F0E442"))+ theme_classic()+ geom_hline(yintercept=0, linetype="dashed",color = "black", size=0.8,alpha=0.1) +geom_vline(xintercept = 0, linetype="dashed",color = "black", size=0.8,alpha=0.1)
...
plot_d4p4 <- ggplot(dat_d4p5 , aes(dat_d4p5[,1], dat_d4p5[,2],color=classification_inter_terminal$`Perching performance` ,label = classification_inter_terminal$sp2,shape=classification$Locomotion)) +
  geom_point(size=7) + geom_text_repel(color="black") + labs(title = "") + geom_encircle(aes(group=classification_inter_terminal$`Perching performance`,fill=classification_inter_terminal$`Perching performance`),colour="darkred", s_shape = 1, expand = 0,
                                                                                         alpha = 0.20, show.legend = FALSE)+xlab("PC1")+ylab("PC2")+scale_shape_manual(values=c(8, 19,17))+scale_color_manual(values=c("#193EE2", "#009E73", "#F0E442"))+scale_fill_manual(values=c("#56B4E9", "#009E73", "#F0E442"))+ theme_classic()+ geom_hline(yintercept=0, linetype="dashed",color = "black", size=0.8,alpha=0.1) +geom_vline(xintercept = 0, linetype="dashed",color = "black", size=0.8,alpha=0.1)
